...
function showToast(message, type = 'info') {
  ...
  // Set className directly instead of using classList.add() to avoid space-separated class error
  toast.className = `px-6 py-4 rounded-lg shadow-xl text-white font-medium transform transition-all duration-300 translate-x-0 ${colors[type] || colors.info}`;
